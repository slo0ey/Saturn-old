...
import com.github.DenFade.Saturn.entity.command.RegisterMSChannel;

import com.github.DenFade.Saturn.entity.command.UnregisterMSChannel;
...
public class Main {
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            logWithTimestamp("Loading Server configurations...");
            ...
            Bot.commandCenter()
                    .register("ms.on", new RegisterMSChannel())
                    .register("ms.off", new UnregisterMSChannel());
